...
| **Volume Limits** | Anti-whale, flash-loan prevention | Cryptographically rejects any transfer exceeding a configured `u64` limit. |
| **KYC Allowlist** | Permissioned trading | Restricts transfers strictly to pre-approved sender and receiver wallets. |
